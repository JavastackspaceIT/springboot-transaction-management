...
public class PassangerInfo {
	...
	public PassangerInfo(int id, String firstName, String lastName, String mobileNo, String emaliId, String source,
			String destination, Date pickupDate, Date landingDate) {
		super();
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
